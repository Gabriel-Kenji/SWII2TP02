...
namespace SWII2TP02.Controllers
{
    public class ContainersController : Controller
    {
        ...
        {
            ViewBag.Lista1 = await _context.BL.ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Tipo,Tamanho")] Container container)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,Tipo,Tamanho")] Container container)
        {
            if (id != container.Id)
            {
                return NotFound();
